...
export const SPEECH_GUIDES = {
  ...
  empresas_rj: (selic: number) => `Análise de viabilidade das empresas brasileiras em regime de Recuperação Judicial R J. Com a Selic em ${selic.toFixed(2)} por cento, o custo de capital e as taxas flutuantes indexadas ao CDI asfixiam o caixa e inviabilizam a reestruturação e sobrevivência dessas companhias. Simular a Selic de um dígito alivia substancialmente o custo do WACC, reduzindo os encargos de dívidas com credores e liberando expansão do valor de firma de ativos estressados.`,
};
