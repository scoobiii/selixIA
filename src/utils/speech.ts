...
export const SPEECH_GUIDES = {
  ...
  empresas_rj: (selic: number) => `Análise de viabilidade das empresas do Rio de Janeiro. Com a Selic em ${selic.toFixed(2)} por cento, o custo de capital e a alavancagem das empresas cariocas ficam severamente comprometidos quando seu retorno de investimento operacional está abaixo desse patamar de juros de dois dígitos. Simular a Selic de um dígito libera valor substancial e promove a reestruturação das companhias sediadas em território carioca.`,
};
